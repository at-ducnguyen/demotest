      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <?php else : ?>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><?php echo 'Chào bạn ('.Yii::$app->user->identity->username.')'; ?> <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  ...
                  . Html::submitButton(
                    'Thoát ra (' . Yii::$app->user->identity->username . ')',
