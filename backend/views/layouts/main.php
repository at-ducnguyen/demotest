...
<ul class="nav navbar-nav navbar-right">
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span style="color: red" class="glyphicon glyphicon-user"></span> <?php echo '<span style="font-weight:bold; color:red">'. Yii::$app->user->identity->username.'<span>'; ?> <span class="caret"></span></a>
          <ul class="dropdown-menu">
